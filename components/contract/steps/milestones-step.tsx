    ...
    <Form {...form}>
      <motion.div className="space-y-4" variants={containerVariants} initial="hidden" animate="visible">
        <motion.div variants={itemVariants}>
          <h2 className="text-xl font-bold text-electric-blue">Project Milestones</h2>
          <p className="text-muted-foreground mt-1 text-sm">Define the milestones and payments for your contract.</p>
        </motion.div>
              ...
              <Card className="border-sky-blue/20 bg-dark/50">
                <CardContent className="p-4">
                  <div className="flex justify-between items-center mb-3">
                    <h3 className="text-base font-semibold text-sky-blue">Milestone {index + 1}</h3>
                    {fields.length > 1 && (
                      <Button
                        variant="ghost"
                        size="icon"
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem className="flex flex-col">
                            <FormLabel className="text-sm">Delivery Date</FormLabel>
                            <Popover>
